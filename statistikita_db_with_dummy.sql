...
-- Data dummy tambahan
(9, 8, 'new_answer', 'admin menjawab pertanyaan Anda: Apakah data BPS bisa digunakan untuk penelitian akademik', 0, '2026-03-03 09:00:00', 8),
(10, 5, 'new_answer', 'deni_k menjawab pertanyaan Anda: Bagaimana cara mengunduh data mikro dari BPS', 0, '2026-03-03 10:00:00', 5),
(11, 4, 'new_answer', 'admin menjawab pertanyaan Anda: Bagaimana cara akses data Sakernas', 0, '2026-03-11 10:00:00', 12),
(12, 6, 'new_answer', 'lestari_n menjawab pertanyaan Anda: Bagaimana cara membandingkan data statistik antar provinsi', 0, '2026-03-15 10:00:00', 14),
(13, 7, 'new_answer', 'ahmad_f menjawab pertanyaan Anda: Apa itu Nilai Tukar Petani', 0, '2026-03-17 16:00:00', 15),
(14, 3, 'new_answer', 'admin menjawab pertanyaan Anda: Apa itu Indeks Pembangunan Manusia', 0, '2026-03-09 10:00:00', 11),
(15, 9, 'new_answer', 'rizky_p menjawab pertanyaan Anda: Apa perbedaan antara angka absolut dan relatif', 0, '2026-03-05 11:00:00', 9),
(16, 5, 'new_answer', 'hendra_w menjawab pertanyaan Anda: Apa perbedaan antara data primer dan data sekunder', 0, '2026-03-13 09:30:00', 13);
...
-- Data dummy tambahan
(16, 8, 'Bagaimana cara membaca Angka Harapan Hidup dalam laporan BPS?', 'Saya ingin memahami indikator Angka Harapan Hidup (AHH) yang sering muncul dalam laporan IPM. Apa pengertiannya, bagaimana cara BPS menghitungnya, dan bagaimana posisi Lampung dibanding nasional?', NULL, '2026-03-17 08:00:00', '2026-03-17 08:00:00', 0),
(17, 9, 'Apa itu Koefisien Gini dan bagaimana menginterpretasikannya?', 'Dalam laporan ketimpangan sering disebut Koefisien Gini. Saya ingin tahu apa itu Koefisien Gini, bagaimana skala interpretasinya, dan bagaimana kondisi ketimpangan di Lampung?', NULL, '2026-03-18 09:00:00', '2026-03-18 09:00:00', 0),
(18, 10, 'Komoditas ekspor unggulan apa saja yang dimiliki Lampung?', 'Sebagai provinsi yang punya banyak produk pertanian, saya ingin tahu komoditas ekspor apa yang menjadi andalan Lampung dan di mana bisa mendapatkan datanya di BPS.', NULL, '2026-03-18 14:00:00', '2026-03-18 14:00:00', 0),
(19, 2, 'Bagaimana kondisi rata-rata lama sekolah di Lampung?', 'Saya ingin mengetahui kondisi pendidikan di Lampung dari sisi statistik, khususnya indikator Rata-rata Lama Sekolah (RLS). Bagaimana perbandingannya antar kabupaten dan dengan nasional?', NULL, '2026-03-19 08:00:00', '2026-03-19 08:00:00', 0),
(20, 3, 'Di mana bisa mengakses publikasi statistik BPS Lampung secara online?', 'Saya baru di Lampung dan ingin mengakses berbagai publikasi statistik tentang provinsi ini. Apakah ada website resmi yang menyediakan semua data tersebut secara lengkap dan terpadu?', NULL, '2026-03-20 07:00:00', '2026-03-20 07:00:00', 0);
...
-- Password untuk semua user (kecuali admin): "password123"
-- Password admin: sesuai hash asli
--
